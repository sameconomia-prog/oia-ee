...
STPS_DEMO: list[StpsVacante] = [
    StpsVacante("ML Engineer Senior","Wizeline","Tecnología",["Python","TensorFlow","MLOps"],80000,120000,HOY,"Jalisco","licenciatura",3),
    StpsVacante("Data Scientist","BBVA México","Finanzas",["Python","SQL","Spark"],60000,90000,HOY - timedelta(days=2),"Ciudad de México","licenciatura",2),
    StpsVacante("Ingeniero en IA","Intel México","Tecnología",["C++","CUDA","Python"],70000,100000,HOY - timedelta(days=1),"Jalisco","licenciatura",3),
    StpsVacante("Analista Financiero","Banorte","Finanzas",["Excel","Python","Bloomberg"],35000,55000,HOY - timedelta(days=3),"Nuevo León","licenciatura",1),
    StpsVacante("Backend Developer","Clip","Fintech",["Go","PostgreSQL","Docker"],50000,80000,HOY,"Ciudad de México","licenciatura",2),
    StpsVacante("Data Engineer","Rappi","Tecnología",["Spark","Airflow","SQL"],55000,85000,HOY - timedelta(days=5),"Ciudad de México","licenciatura",2),
    StpsVacante("Product Manager IA","Konfío","Fintech",["Python","A/B Testing","SQL"],65000,95000,HOY - timedelta(days=4),"Ciudad de México","licenciatura",4),
    StpsVacante("Científico de Datos","INEGI","Gobierno",["R","Python","Estadística"],30000,45000,HOY - timedelta(days=7),"Ciudad de México","licenciatura",2),
    StpsVacante("Desarrollador IA","Aeromexico","Logística",["Python","NLP","REST API"],45000,70000,HOY - timedelta(days=2),"Ciudad de México","licenciatura",2),
    StpsVacante("ML Ops Engineer","OCC Mundial","Tecnología",["Kubernetes","MLflow","Python"],60000,90000,HOY - timedelta(days=1),"Jalisco","licenciatura",3),
    StpsVacante("Analista de Riesgo","Grupo Financiero Santander","Finanzas",["SAS","Python","SQL"],38000,58000,HOY - timedelta(days=6),"Ciudad de México","licenciatura",2),
    StpsVacante("NLP Engineer","Conekta","Fintech",["Python","BERT","FastAPI"],55000,82000,HOY,"Ciudad de México","licenciatura",3),
    StpsVacante("Ingeniero de Manufactura IA","CEMEX","Manufactura",["Python","SCADA","IoT"],40000,65000,HOY - timedelta(days=3),"Nuevo León","licenciatura",2),
    StpsVacante("Research Scientist","CIMAT","Educación",["Python","PyTorch","LaTeX"],35000,55000,HOY - timedelta(days=8),"Guanajuato","maestría",1),
    StpsVacante("Full Stack Developer","Kavak","Tecnología",["React","Node.js","PostgreSQL"],45000,70000,HOY - timedelta(days=2),"Ciudad de México","licenciatura",2),
    StpsVacante("Especialista en Ciberseguridad IA","Telcel","Telecomunicaciones",["Python","SIEM","ML"],50000,80000,HOY - timedelta(days=1),"Ciudad de México","licenciatura",3),
    StpsVacante("Data Analyst","Liverpool","Retail",["SQL","Power BI","Python"],28000,42000,HOY - timedelta(days=4),"Ciudad de México","licenciatura",1),
    StpsVacante("Arquitecto de Soluciones IA","Oracle México","Tecnología",["Python","OCI","ML"],90000,130000,HOY - timedelta(days=3),"Jalisco","licenciatura",5),
    StpsVacante("Ingeniero en Robótica","Bosch México","Manufactura",["ROS","Python","C++"],48000,72000,HOY - timedelta(days=5),"Puebla","licenciatura",3),
    StpsVacante("Analista BI","Coppel","Retail",["Power BI","SQL","Python"],25000,40000,HOY - timedelta(days=6),"Sinaloa","licenciatura",1),
    StpsVacante("DevOps Engineer","Kueski","Fintech",["Terraform","AWS","Python"],55000,85000,HOY - timedelta(days=2),"Ciudad de México","licenciatura",3),
    StpsVacante("Especialista en IA Educativa","Aprende.mx","Educación",["Python","EdTech","NLP"],40000,60000,HOY - timedelta(days=1),"Ciudad de México","licenciatura",2),
    StpsVacante("Científico de Datos en Salud","IMSS","Salud",["R","Python","SQL"],32000,48000,HOY - timedelta(days=9),"Ciudad de México","maestría",2),
    StpsVacante("Computer Vision Engineer","Mabe","Manufactura",["OpenCV","Python","TensorFlow"],52000,78000,HOY - timedelta(days=4),"Estado de México","licenciatura",3),
    StpsVacante("AI Product Analyst","Mercado Libre","E-commerce",["SQL","Python","Tableau"],50000,75000,HOY,"Ciudad de México","licenciatura",2),
]
